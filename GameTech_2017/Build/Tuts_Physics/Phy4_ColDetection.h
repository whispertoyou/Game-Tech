...
public:
	...
	virtual void OnUpdateScene(float dt) override
	{
		...
		if (m_Rotating)
		{
			...
			Vector4 col2 = CommonUtils::GenColour(0.7f, 0.5f);
			...
			if (orbiting_sphere1 != NULL)
			{
				...
				orbiting_sphere1->SetColour(orbiting_sphere1->Physics()->IsColliding() ? col2 : col);
			}
			...
			if (orbiting_sphere2 != NULL)
			{
				...
				orbiting_sphere2->SetColour(orbiting_sphere2->Physics()->IsColliding() ? col2 : col);
			}
			...
			if (rotating_cuboid1 != NULL)
			{
				...
				rotating_cuboid1->SetColour(rotating_cuboid1->Physics()->IsColliding() ? col2 : col);
			}
		}
