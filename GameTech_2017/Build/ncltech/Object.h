...
public:
	...
	//void SetCol(const bool& b) { m_collision = b; }
	//const bool& GetCol() { return m_collision; }
	...
	//new 12/15 return all game objs
	std::vector<Object*> GetAllGameObj() { return m_vpChildren; };
