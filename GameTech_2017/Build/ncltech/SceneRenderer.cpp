...
bool SceneRenderer::InitialiseGL()
{
	...
	m_SkyboxTex = SOIL_load_OGL_cubemap(
		TEXTUREDIR"starfield_lf.tga", TEXTUREDIR"starfield_rt.tga",
		TEXTUREDIR"starfield_up.tga", TEXTUREDIR"starfield_dn.tga",
		TEXTUREDIR"starfield_bk.tga", TEXTUREDIR"starfield_ft.tga",
		SOIL_LOAD_RGB, SOIL_CREATE_NEW_ID, 0);
	if (!m_SkyboxTex) {
		NCLERROR("Skybox Texture ERROR!");
		return false;
	}
...
bool SceneRenderer::ShadersLoad()
{
	...
	m_SkyboxShader = new Shader(SHADERDIR"SceneRenderer/skyboxVertex.glsl",
