...
public:
	...
	//sleep mode
	inline void	SetIsColliding(bool isCollide)						{ m_IsColliding = isCollide; }
	...
	//<------- SLEEPONG MODE -------->
	//Get/Set sleeping mode
	inline void SetSleepMode(bool sleep) { m_sleep = sleep; };
	inline bool GetSleepMode() { return m_sleep; }
